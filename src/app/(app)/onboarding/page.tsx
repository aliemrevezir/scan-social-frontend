...
const brandDetailsSchema = z.object({
  ...
  product_service_type: z.string().trim().optional(),
  geography: z.string().trim().optional(),
  target_audience: z.string().trim().optional(),
  brand_description: z.string().trim().optional(),
  preferred_platforms: z.string().trim().optional(),
  kpis: z.string().trim().optional(),
  voice_tone: z.string().trim().optional(),
  brand_archetype: z.string().trim().optional(),
  visual_identity: z.string().trim().optional(),
  preferred_influencer_tier: z.string().trim().optional(),
  ad_language: z.string().trim().optional(),
  ad_duration_pref: z.string().trim().optional(),
  campaign_goal: z.string().trim().optional(),
});
